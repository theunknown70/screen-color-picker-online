    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Box component="article" sx={{ mt: 4 }}>
        ...
        <Typography paragraph>
          ...
          which the initial letter is capitalized have meanings defined under
          ...
          plural. Definitions For the purposes of these Terms and Conditions:
          Affiliate means an entity that controls, is controlled by or is under
          common control with a party, where "control" means ownership of 50% or
          more of the shares, equity interest or other securities entitled to
          vote for election of directors or other managing authority. Country
          refers to: Berlin, Germany Company (referred to as either "the
          Company", "We", "Us" or "Our" in this Agreement) refers to test.
          ...
          Conditions agreement has been created with the help of the TermsFeed
          Terms and Conditions Generator. Third-party Social Media Service means
          ...
          made available by the Service. Website refers to test, accessible from
          pickcoloronline.com You means the individual accessing or using the
          ...
          these Terms and Conditions. Upon termination, Your right to use the
          ...
          to the greatest extent permitted by law. "AS IS" and "AS AVAILABLE"
          Disclaimer The Service is provided to You "AS IS" and "AS AVAILABLE"
          ...
          greatest extent enforceable under applicable law. Governing Law The
          laws of the Country, excluding its conflicts of law rules, shall
          govern this Terms and Your use of the Service. Your use of the
          Application may also be subject to other local, state, national, or
          international laws. Disputes Resolution If You have any concern or
          dispute about the Service, You agree to first try to resolve the
          dispute informally by contacting the Company. For European Union (EU)
          Users If You are a European Union consumer, you will benefit from any
          mandatory provisions of the law of the country in which you are
          resident in. United States Legal Compliance You represent and warrant
          that (i) You are not located in a country that is subject to the
          ...
          or restricted parties. Severability and Waiver Severability If any
          ...
          email: theunknown070707@gmail.com
        </Typography>
